                                        ...
                                        <tr>
                                            ...
                                            <td class="action-buttons">
                                                <button type="button" class="subcategory" data-id="<?php echo $value->subcat_id; ?>" name="submit" class="catbutton">
                                                  ...
                                                  <a onclick="return confirm('Are you sure to delete this data?')" href="subcategory_delet?id=<?php echo $value->subcat_id; ?>"<?php if($value->subcat_id == $this->session->userdata('user_login_id')){ echo 'hidden'; } ?> >
...
$(document).ready(function () {
    $(".subcategory").click(function (e) {
        ...
        $('#subcategoryform').modal('show');
        $.ajax({
            url: '<?php echo base_url()?>subcategory/getSubcategoryByid?id=' + iid,
            method: 'GET',
            data: '',
            dataType: 'json',
