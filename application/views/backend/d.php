    ...
    $(function() {
        ...
        <div class="wrapper-page">
            ...
            <div class="page-title">
                <h1><i class="icon-grid"></i>Currency Exchange</h1>
            </div>
...
<button class="btn btn-custom" onclick="myFunction()" style=" font-size: 23px;">Refresh</button>
...
<br>
      ...
      <div class="table_body text-left" style="background-color: lightgreen;">
        <h3 style="color: blue;">Today Currency Rate</h3><br>
...
<section>
  ...
  <form class="form-group" action="/action_page.php" style="height: 300px; width: 50%;background-color: powderblue;" >
    ...
    <br>
                                <h2>
                                <label class="control-label col-sm-6" for="Aamount" style="color: blue">Customer Sell:</label>
                                </h2>
    ...
    <br><br>
                             ...
                             <h2>
                                  <label class="control-label col-sm-6" for="Ato" style="color: blue">From Currency:</label>
                             ...
                             <br><br>
                             <h2>
                                  <label class="control-label col-sm-6" for="Afrom" style="color: blue">To Currency:</label>
...
function OnSelecteds()
{
   ...
   <div class="form-group">
    ...
    <br>
               <h2>
                   <label class="control-label col-sm-6" for="amount" style="color: blue">Customer Buy:</label>
               </h2>
      ...
      <br><br>
                ...
                <h2>
                <label class="control-label col-sm-6" for="Bfrom" style="color: blue">From Currency:</label>
    ...
    <br><br>
       ...
       <h2>
         <label class="control-label col-sm-6" for="Bto" style="color: blue">To Currency:</label>
       </h2>
       <div class="col-sm-6">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header modal-primary">
                ...
                <h3 class="modal-title" id="modal-label">Your Amount is</h3>
            </div>
