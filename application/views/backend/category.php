                                    ...
                                    <tr>
                                        ...
                                        <td class="action-buttons">
                                            <button type="button" id="category" data-id="<?php echo $value->cat_id; ?>" name="submit" class="catbutton">
                                                 ...
                                                 <a onclick="return confirm('Are you sure to delete this data?')" href="category_delet?id=<?php echo $value->cat_id; ?>"<?php if($value->cat_id == $this->session->userdata('user_login_id')){ echo 'hidden'; } ?> >
...
<script>
    $("#addcategory").on("click", function(event) {
        ...
        $.ajax({
            url: "<?php echo base_url();?>category/addCategoryData",
            type: "POST",
            dataType: 'json',
            data: {
                'cat_id': $('#catid').val(),
