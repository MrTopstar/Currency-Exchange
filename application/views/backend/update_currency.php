                            ...
                            <div class="content_wrapper">
                                ...
                                <div class="table_body">
                                    <form action="updateProduct" id="fileUploadForm" method="post" enctype="multipart/form-data" accept-charset="utf-8">
                                        ...
                                        <div class="form-group clearfix">
                                            <label for="category" class="col-md-3">Country</label>
                                            <div class="col-md-9">
                                                <select class="form-control" id="cotid" onchange="OnCountry()" name="cotid">
                                                    <option value="<?php echo $productvalue->country_id; ?>"><?php echo $productvalue->country_name; ?></option>
                                       ...
                                       <div class="form-group clearfix">
                                            <label for="category" class="col-md-3">Sub-category</label>
                                            <div class="col-md-9">
...
<script type="text/javascript">
    function OnCountry(){
        var x = document.getElementById("cotid").value;
        console.log(x);
    $.ajax({
      type: "GET",
      url: 'getCountryByID?c=' + x,
      success: function(response) {
        $("#subcatlist").html(response);
        //console.log(response);
      }
